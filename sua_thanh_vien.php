...
<head>
    ...
    <title>Sửa thành viên</title>
      ...
      function confirmAction() {
        return confirm("Bạn có muốn thực hiện thay đổi?")
      }
...
<form action="" method="post" enctype="multipart/form-data" onSubmit="return confirmAction()" > 
    <table width="990px" >
        <tr>
            <td colspan="2" ><b style="color:blue;font-size:20px" >Sửa Thông Tin: <?php echo $hoVaTen; ?> </b><br><br> </td>
        ...
        <tr>
            ...
            <td>
                <br>
                <input type="submit" name="bieu_mau_sua" value="Sửa" style="width:200px;height:50px;font-size:24px" >
            </td>
        </tr>
    </table>
</form>
